        ...
        <div key={data?.id} className='group mb-3 flex cursor-pointer items-center'>
          ...
          <div>
            <div className='flex translate-y-[2px] items-center'>
              <h4 className='text-fontSizeName font-semibold tracking-wider group-hover:underline'>{data?.nickname}</h4>
              {data?.tick && (
                <div className='ml-1'>
                  <svg
            ...
            <span className='text-fontSizeMin font-thin text-[rgba(22,24,35,0.75)]'>
              <span>{`${data?.first_name} ${data?.last_name}`}</span>
              <span className='m-[0_4px] align-top'>.</span>
