...
import { OffVolume, PauseVideo, PlayVideo, Volume } from '../../../../Icons/Icons'

export default function Live() {
  return (
    <div role='status' class='animate-pulse space-y-8 md:flex md:items-center md:space-y-0 md:space-x-8'>
